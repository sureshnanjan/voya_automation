...
let reptiles: Pet = {
  ...
  category: { id: 3, name: "Mito" },
  name: "Vibrant Green Iguana",
...
let catUser: User = { id: 722106, username: "Pet_Store_1", firstName: "Vidya", lastName: "P", email: "Jhone.Reed@test.com", password: "securePass123", phone: "555-123-4567", userStatus: 1 }
 
// Birds

let birdsResponse: ApiResponse = { code: 200, type: "success", message: "Amazon Bird parcel" }
